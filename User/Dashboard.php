...
if ($b !== false && mysqli_num_rows($b) > 0) {
    ...
    // Handle the case where no results were found or the query failed.
    $d = 'Email not found'; // You can set an appropriate default value or error message.
}
...
<?php include('master.php'); ?>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Patil International Bank</h1>
